...
<body>
    ...
    <div class="d-flex flex-row">
        ...
        <div class="flex-col m-3">
            ...
            <form action="{{ route('updateMember', ['id' => $member->id]) }}" method="GET">
                @csrf
                
                <label for="nameForm" class="form-label">Name</label>
                <input type="text" name="nameForm" class="form-control" placeholder="Enter Name Here" value="{{ $member->name ?? '' }}">
                ...
                <input type="text" class="form-control" name="phoneForm" placeholder="Enter Phone Number"
                    inputmode="numeric" pattern="[0-9]*" value="{{ $member->phone ?? '' }}">
                <br>
